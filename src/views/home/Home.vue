    ...
    <v-row class="home-container">
      <v-col md="9" cols="12">
        ...
        <!-- <v-carousel
          ...
          style="border-radius: 12px 8px 8px 12px; margin-top: 20px"
        >
          <v-carousel-item v-for="(item, index) in recommindList" :key="index">
        ...
        <v-pagination
          v-if="Math.ceil(blogInfo.articleCount / 10) > 1"
          v-model="current"
          :length="Math.ceil(blogInfo.articleCount / 10)"
          :total-visible="10"
          @input="infiniteHandler(current)"
          circle
      ...
      <v-col md="3" cols="12" class="d-md-block d-none">
        <div class="blog-wrapper">
          ...
          <!-- 微博热搜榜 -->
          <v-card class="animated zoomIn blog-card mt-5 weibo">
            <div class="weibo-container">
              <div class="item-headline">
                <i class="iconfont icontweibo" style="font-size: 25px" />
              ...
              >
                <div class="weibo-list-item">
                  <div :class="['weibo-hotness', hotness[item.iconDesc || '荐']]">
                    {{ item.iconDesc || '荐' }}
                  </div>
                  <span class="weibo-title">
                    <a
                      :href="item.url"
                      :title="item.title"
                      target="_blank"
          ...
          <v-card class="animated zoomIn blog-card mt-5">
            ...
            <div id="follow-us" ref="follow" class="guanzhu">
              ...
              <ul>
                ...
                <li class="qq">
                  <a
                    href="tencent://AddContact/?fromId=50&fromSubId=1&subcmd=all&uin=329390073"
                    target="_blank"
                    >329390073</a
                  >
                </li>
                <li class="email">
                  <a href="mailto:329390073@qq.com">329390073@qq.com</a>
                </li>
                <li class="github">
                  <a href="https://github.com/fourteenPeanuts" target="_blank"
                    >https://github.com/fourteenPeanuts</a>
                </li>
                <li class="gitee">
                  <a href="https://gitee.com/fourteen-peanuts" target="_blank"
                    >https://gitee.com/fourteen-peanuts</a
                  >
                </li>
...
export default {
  ...
  methods: {
    ...
    initWeibo () {
       ...
       axios.get("/api/thirdPart/weiboHotSearch").then(({ data }) => {
    ...
    infiniteHandler (current, scroll = true) {
        ...
        .then(({ data }) => {
          if (data.data.length) {
            ...
            if (scroll) {
              ...
              this.recommindList = this.getRandomArrayElements(data.data, 6);
            }
          }
        });
    },
