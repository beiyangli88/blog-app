  ...
  <div>
    ...
    <div class="bbox" :class="{ bbox_active: disActive }">
      <div
        ...
        @click="DisActive"
      >
        <img :src="musicImg || defaultImg" alt="" class="pan_c" />
      </div>
      <div
        class="box"
        ...
        <div class="music_dis">
          ...
          <ul class="music_words">
            <div class="music_words_box" :style="{ top: wordsTop + 'px' }">
              ...
              <div style="font-size: 10px" v-if="musicWords.length == 0">
                当前网络异常，加载失败！
              </div>
            </div>
          </ul>
...
export default {
  ...
  data () {
    return {
      ...
      //新增歌词评论
      hotTalkList: [],
      defaultImg: 'https://myblogphoto-1313051656.cos.ap-guangzhou.myqcloud.com/photos%2Fmusciwangyiyun.png'
    };
  },
  mounted () {
    this.Player();
